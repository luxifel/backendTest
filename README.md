...
1. Please use one of the following languages/frameworks: *PHP*, *Javascript (Node + Express)* or *Python* - listed in descending order of desirability. 
...
5. You can write some automated tests if you want to;
